...
export const useReaderStore = defineStore('reader-store', {
  state: () => ({
    uuid: 6,
    bookID: 2,
    book: "1 Nephi",
  ...
  // getters: {
  //   reader: (state) => ({ uuid: state.uuid, bookID: state.bookID, book: state.book, chapter: state.chapter, narrator: state.narrator, narratorImageName: state.narratorImageName, chapterImageName: state.chapterImageName, audioFileName: state.audioFileName, isActiveBookmark: state.isActiveBookmark, src: state.src })
